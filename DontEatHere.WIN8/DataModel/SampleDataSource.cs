...
using LinqToExcel;
using DontEatHere.WIN8.DataModel;
...
namespace DontEatHere.WIN8.Data
{
    /// <summary>
    ...
    public abstract class SampleDataCommon : DontEatHere.WIN8.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        public SampleDataSource()
        {
            ...
            IEnumerable<String> groupTitle = model.Select(e => e.FacilityName);
